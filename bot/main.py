...
from bot.handlers import start_handler, whoami_handler, create_voice_handler, add_authorization, chat_handler, reply_handler, track_history_handler, adduser_handler, Role
...
if __name__ == '__main__':
    ...
    add_authorization(adduser_handler, Role.admin)
